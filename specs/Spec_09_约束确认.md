...
展示顺序为：餐次、人数、菜品数量、最长制作时间、难度、现有食材，再按原顺序展示各菜品组的数量、类型、口味、菜系、功效、适用人群、所需食材、主食来源和排除主食。

- null、空容器、“未指定”、证据、编号和变更声明不展示。
- 数组使用 `、` 连接并保留原顺序。
- 口味按甜、清淡、辣、咸、酸排序，分别显示甜/不甜、清淡/不清淡、辣/不辣、咸/不咸、酸/不酸。
- 人数、菜数、组数量和时间分别显示为 `N人`、`N道`、`N道`、`N分钟以内`。
- 菜品组标签固定为 `菜品组N数量、菜品组N类型、菜品组N口味、菜品组N菜系、菜品组N功效、菜品组N适用人群、菜品组N所需食材`。
- 菜品组主食标签固定为`菜品组N主食来源、菜品组N排除主食`。值保持输入顺序：all 单项直接显示，2项用“和”、3项及以上用“、”分隔前项并在末项前用“和”；any固定至少2项，2项用“或”、3项及以上用“、”分隔前项并在末项前用“或”；排除数组用“、”连接。
